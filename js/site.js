...
const ie = {
    ...
    const i = {
        ...
        loadFont: () => {
            ...
            t.rel = "stylesheet", t.href = "https://fonts.googleapis.com/css?family=Poppins:400,500,700&display=swap", (document.head || document.getElementsByTagName("head")[0]).appendChild(t)
        }
    };
    t.exports = i
}, function(t, e, i) {
